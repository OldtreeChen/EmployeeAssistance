...
function _menuBtn(label, bgColor, textColor, postbackData, displayText) {
  return {
    ...
    backgroundColor: bgColor, cornerRadius: '12px',
    paddingTop: '14px', paddingBottom: '14px', paddingStart: '14px', paddingEnd: '12px',
    action: { type: 'postback', data: postbackData, displayText },
    contents: [
      { type: 'text', text: label, color: textColor, size: 'md', weight: 'bold', flex: 1 },
      { type: 'text', text: '›', color: textColor, size: 'lg', flex: 0, align: 'end', opacity: 0.4 },
    ],
  };
}
...
function _sectionLabel(text) {
  return {
    type: 'box', layout: 'horizontal', paddingTop: '6px', paddingBottom: '2px',
    paddingStart: '4px', paddingEnd: '4px', alignItems: 'center',
    contents: [
      { type: 'text', text, size: 'xxs', color: '#94a3b8', weight: 'bold', flex: 0 },
      { type: 'box', layout: 'vertical', flex: 1, margin: 'sm', height: '1px', backgroundColor: '#e2e8f0', contents: [] },
    ],
  };
}
...
function buildQuickMenuFlex(userId) {
  ...
  // ── 精簡 header 建構器 ───────────────────────────────
  function _cardHeader(bgColor, emoji, title, tagText) {
    return {
      type: 'box', layout: 'horizontal', backgroundColor: bgColor,
      paddingTop: '12px', paddingBottom: '12px', paddingStart: '14px', paddingEnd: '14px',
      alignItems: 'center', spacing: 'sm',
      contents: [
        { type: 'text', text: emoji, size: 'lg', flex: 0 },
        { type: 'text', text: title, weight: 'bold', color: '#ffffff', size: 'md', flex: 1 },
        {
          type: 'box', layout: 'vertical', flex: 0,
          backgroundColor: 'rgba(255,255,255,0.22)', cornerRadius: '20px',
          paddingTop: '3px', paddingBottom: '3px', paddingStart: '8px', paddingEnd: '8px',
          contents: [{ type: 'text', text: tagText, size: 'xxs', color: '#ffffff', weight: 'bold' }],
        },
      ],
    };
  }
  ...
  const attendCard = {
    ...
    header: _cardHeader('#52b788', '🕐', '出勤管理', '打卡 · 請假'),
    body: {
      ...
      contents: [
        ...
        _sectionLabel('🏖️ 請假'),
        _menuBtn('🌴 餘假查詢', '#fef3c7', '#92400e', 'action=leave_balance', '餘假查詢'),
  ...
  const workCard = {
    type: 'bubble', size: 'kilo',
    header: _cardHeader('#9b72cf', '📊', '日常作業', '工時 · 會議室'),
    body: {
      type: 'box', layout: 'vertical', spacing: 'sm', paddingAll: '10px',
      contents: [
  ...
  const accountCard = {
    type: 'bubble', size: 'kilo',
    header: _cardHeader('#64748b', '⚙️', '帳號管理', '設定'),
    body: {
      type: 'box', layout: 'vertical', spacing: 'sm', paddingAll: '10px',
      contents: [
        {
          ...
          contents: [
            { type: 'text', text: '🔑 帳號設定', color: '#1e3a5f', size: 'md', weight: 'bold', flex: 1 },
            { type: 'text', text: '›', color: '#1e3a5f', size: 'lg', flex: 0, align: 'end', opacity: 0.4 },
          ],
        },
      ],
    },
